...
class Video2ImageTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     *
     * @var \MediAlchemyst\Specification\Image
     */
    protected $specs;
    protected $source;
    protected $dest;
    ...
    {
        $this->object = new Video2Image(new \MediAlchemyst\DriversContainer(new \Symfony\Component\DependencyInjection\ParameterBag\ParameterBag(array())));
    ...
    /**
     * @covers MediAlchemyst\Transmuter\Video2Image::execute
     */
    ...
    {
        $this->object->execute(new \MediAlchemyst\Specification\Video(), $this->source, $this->dest);
    }

    /**
     * @dataProvider getTimeAndPercents
     * @covers MediAlchemyst\Transmuter\Video2Image::parseTimeAsRatio
     */
